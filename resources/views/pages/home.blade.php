    ...
    <div class="site-wrapper-reveal">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="about-us-content_6 text-center ">
                            <h2 class=text-color-primary>BNB&nbsp;&nbsp;Store</h2>
                            <p>
                                <small>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-video-box">
                            <img src="https://www.jeplus1.com/wp-content/uploads/2021/04/je1-Bensons-for-beds-megastores-uai-2000x1000.jpg" alt="">
                            <div class="video-icon">
                                <a href="https://youtu.be/BxHwpLnFXdU?si=c1larMmXuKDGrbYF" class="popup-youtube"><i class="linear-ic-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @for($i=1;$i<=$partner_count;$i++)
                        <div class="col-lg-12">
                            <div class="single-brand-item">
                                <a href="#"><img src="{{ asset('assets/images/brand/partnerb' . $i . '.png') }}" class="img-fluid" alt="Partner Images"></a>
                            </div>
                        </div>
                    @endfor
                </div>
        ...
        <div class="our-member-area section-space--ptb_120">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="member--box" style="background-color:#FCF7E8;">
